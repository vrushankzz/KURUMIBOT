...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am an Anime themed group management bot. I will use my angel and protect your group. You can find my list of available commands with /help.
"""
...
TOKISAKI_IMG = "https://telegra.ph/file/5a5a7a30253abc69ff154.jpg"
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add Valencia to your group",
                     ...
                     [
                         ...
                         InlineKeyboardButton(
                             text="My luv ❤",
                             url="https://t.me/ValenciaOwner")
                    ], 
                     [
                         InlineKeyboardButton(
                             text="🔔 Updates of Valencia🔔",
                             url="https://t.me/valenciaupdates")
                    ], 
                     [
                         InlineKeyboardButton(
                             text="Community",
